/**
 * Inline brand and utility marks. Kept as paths rather than an icon package so
 * nothing ships a whole library for six glyphs.
 */
...
export function ArrowIcon({ className = "size-3" }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
