  ...
  const data = [
    {
      ...
      content: (
        <div>
          <p className="mb-6 sm:mb-8 text-3xl sm:text-4xl lg:text-5xl font-normal text-neutral-800 dark:text-neutral-200">
            VITBMUN Tech Lead
          </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 mt-4">
            <Image
              ...
              width={500}
              height={500}
              className="h-16 sm:h-20 lg:h-44 xl:h-60 w-full rounded-lg object-cover shadow-[0_0_24px_rgba(34,_42,_53,_0.06),_0_1px_1px_rgba(0,_0,_0,_0.05),_0_0_0_1px_rgba(34,_42,_53,_0.04),_0_0_4px_rgba(34,_42,_53,_0.08),_0_16px_68px_rgba(47,_48,_55,_0.05),_0_1px_0_rgba(255,_255,_255,_0.1)_inset]"
            />
            <Image
              src="/Leave.png"
