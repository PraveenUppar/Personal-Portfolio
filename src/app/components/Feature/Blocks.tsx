...
export function Block() {
  ...
  return (
    <div>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 relative z-10 py-6 sm:py-8 lg:py-10 max-w-7xl mx-auto gap-4 lg:gap-0">
...
const Feature = ({
  ...
  return (
    <div
      className={cn(
        "flex flex-col lg:border-r py-6 sm:py-8 lg:py-10 relative group/feature dark:border-neutral-800 px-4 lg:px-0",
